...
class Message extends Model {
  ...
  const Message._internal({required this.id, required roomId, required userId, required message, required removed, createAt, updateAt, createdAt, updatedAt}): _roomId = roomId, _userId = userId, _message = message, _removed = removed, _createAt = createAt, _updateAt = updateAt, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Message({String? id, required String roomId, required String userId, required String message, required bool removed, TemporalDateTime? createAt, TemporalDateTime? updateAt}) {
  ...
  Message copyWith({String? roomId, String? userId, String? message, bool? removed, TemporalDateTime? createAt, TemporalDateTime? updateAt}) {
    return Message._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'roomId': _roomId, 'userId': _userId, 'message': _message, 'removed': _removed, 'createAt': _createAt?.format(), 'updateAt': _updateAt?.format(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  
  Map<String, Object?> toMap() => {
    'id': id, 'roomId': _roomId, 'userId': _userId, 'message': _message, 'removed': _removed, 'createAt': _createAt, 'updateAt': _updateAt, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };
